...
/* TODO: Stop using p_ptr->magicnum*. Rewrite load/save code and keep a local
   ...
   has been removed from the birth menus, so you cannot create one. Note, the SV_FOO defines
   have been moved here temporarily until this class gets rewritten.
*/
