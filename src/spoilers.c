...
static void _help_file(cptr name, _file_fn fn)
{
    ...
    fn(fp);
    fprintf(fp, "\n\n<color:s>Automatically generated for PosChengband R %d.%d.%d.</color>\n",
...
static _race_group_t _race_groups[_MAX_RACE_GROUPS] = {
    ...
    { "Other Races",
        {RACE_ANDROID, RACE_BEASTMAN, RACE_CENTAUR, RACE_DRACONIAN, RACE_DOPPELGANGER, RACE_ENT,
         RACE_GOLEM, RACE_KLACKON, RACE_KUTAR, RACE_MIND_FLAYER, RACE_TONBERRY, RACE_VISITOR, RACE_YEEK,-1 } },
};
